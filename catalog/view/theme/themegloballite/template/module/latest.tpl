...
<div class="box <?php if($theme_options->get( 'product_scroll_latest' ) != '0') { echo 'with-scroll';  } ?>">
  ...
  <div class="box-heading">Популярные модели электрокотлов</div>
  ...
  <div class="btns-text">
	<a href="katalog-produktsii-c59.html">Перейти в каталог</a> или <button type="button" class="text-btn" data-toggle="modal"  data-target="#callModal">Заказать консультацию</button>
  </div>
</div>
