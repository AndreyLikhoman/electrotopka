...
<?php include('catalog/view/theme/'.$config->get('config_template').'/template/themeglobal/themeglobal_top_cat.tpl'); ?>
  ...
  <div class="product-filter clearfix">
  		<div class="filt-bl">
  			<label for=""><?php echo $text_sort; ?></label>
  		...
  		<div class="filt-bl">
  			<label for=""><?php echo $text_limit; ?></label>
  			<select onchange="location = this.value;">
  ...
  <div class="product-grid "<?php if(!($theme_options->get('default_list_grid') == '1')) { echo ' style="display:none;"'; } ?>>
    ...
    <div class="row pagination-results">
		<nav class="page-pag"><?php echo $pagination; ?></nav>
	</div>
  <?php } ?>
	...
	<div class="how-work">
		...
		<ul class="work-list">
			<li class="work1">
				...
				<div class="work-text">Вы заказываете товар</div>
			</li>
			<li class="work2">
				<div class="work-icon"></div>
				<div class="work-text">Мы связываемся<br> с вами</div>
			</li>
			<li class="work3">
				<div class="work-icon"></div>
				<div class="work-text">Доставляем<br> ваш заказ</div>
			</li>
			<li class="work4">
				<div class="work-icon"></div>
				<div class="work-text">Вы получаете<br> и оплачиваете</div>
			</li>
		</ul>
		<div class="work-after">Все очень просто!</div>
	</div>
 <!--==HOW WORK END==--> 
