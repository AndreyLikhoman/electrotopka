      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-center">
              ...
              &nbsp;
              <input type="image" src="catalog/view/theme/<?php echo $config->get( 'config_template' ); ?>/image/update.png" alt="<?php echo $button_update; ?>" title="<?php echo $button_update; ?>" />
              &nbsp;<a onclick="cart.remove('<?php echo $product['key']; ?>');"><img src="catalog/view/theme/<?php echo $config->get( 'config_template' ); ?>/image/remove.png" alt="<?php echo $button_remove; ?>"  style="cursor:pointer;" title="<?php echo $button_remove; ?>" /></a>
          </td>
...
<div class="panel-group tg-checkout" style="margin-bottom: 20px;" id="accordion"><?php echo $coupon; ?><?php echo $voucher; ?><?php echo $reward; ?><?php echo $shipping; ?></div>-->
<?php } ?>
...
<div class="buttons">
  <!--<div class="pull-left"><a href="<?php echo $continue; ?>" class="button back-btn">Вернуться на главную</a></div>-->
  <div class="pull-left"><a href="<?php echo $checkout; ?>" class="button ord-btn"><?php echo $button_checkout; ?></a></div>
</div>
