	...
	<div class="left">
		...
		<?php } else { ?>
			<div class="image prod-img">
				...
				<a href="<?php echo $product['href']; ?>"><img src="image/no_image.png" alt="<?php echo $product['name']; ?>" class="no-image" <?php if($theme_options->get( 'product_image_effect' ) == '2') { echo 'class="zoom-image-effect"'; } ?> /></a>
			</div>
		<?php } ?>
	</div>
	<div class="right">
