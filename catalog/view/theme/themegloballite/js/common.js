$(document).ready(function() {
    ...
    $('.show-nav').click(function(){
      var dropNav = $('.nav-list');
      if(!dropNav.hasClass('open')){
        dropNav.addClass('open').slideDown();
      } else {
        dropNav.removeClass('open').slideUp();
      }    
    });
  
    $('.show-search').click(function(){
      var searchBlock = $('.top-search');
      if(!searchBlock.hasClass('open')){
        searchBlock.addClass('open').slideDown();
      } else {
        searchBlock.removeClass('open').slideUp();
      }
    }); 
...
$(function() {
	$(".upload-file input").change(function (){
	   ...
	   $(".upload-file span").html(fileName);
	});
});
...
setInterval(function(){ 
    ...
    $('.timer').html(hours + ':' + minutes + ':' +secondes);
    }
